...
export const skillsMasterList: BJJConcept[] = [
  ...
  {
    "_id": "68341b18298185c511cdef52",
    "id": "BJJ-001",
    "concept": "3/32 Distance",
    "description": "control the distance, key of any combat discipline",
    "short_description": "",
    "category": "32 Principles",
    "color": "#FFD700",
  ...
  {
    "_id": "683f3c712ac60d8840bbf0f3",
    "id": "BJJ-075",
    "concept": "Vibration",
    "description": "Vibration, or jerking; used by Jason Scully and the DDS.   Short jerky motions to overload the proprioception of the opponent.  collar ties, grips; etc:",
    "short_description": "",
    "category": "Technique",
    "color": "#4F8EF7",
    "axis_self_opponent": 0.15,
  ...
  {
    "_id": "684147b8c0c378ef5989417d",
    "id": "BJJ-075",
    "concept": "Refuse Bottom",
    "description": "Do not go gently into the bottom position, rage, rage against the dying of your options.",
    "short_description": "",
    "category": "Tactic",
    "color": "#8A2BE2",
    "axis_self_opponent": 0.89,
  ...
  {
    "_id": "684152af2fdabf8500a3d5fc",
    "id": "BJJ-082",
    "concept": "\"Almost Right\" = Wrong",
    "description": "“almost right” = wrong. Because control is binary at the threshold:\nEither the joint is locked or it isn’t. The hip is pinned or it's mobile.",
    "short_description": "",
    "category": "Tactic",
    "color": "#8A2BE2",
    "axis_self_opponent": 0.1,
  ...
  {
    "_id": "6841586461e6e82e62aef3f1",
    "id": "BJJ-083",
    "concept": "Climbing the Ladder",
    "description": "From Wrestling.\n\nA metaphorical and mechanical concept describing the sequential advancement of control from lower body to upper body—ankle → knee → hip → torso → head—in order to consolidate a dominant position or finish a takedown.\n\n🧩 Functional Meaning:\nStart with low-level control (ankle pick, single leg).\n\nProgressively climb joints by connecting to higher levers.\n\nEach rung climbed reduces opponent’s mobility and increases your leverage.\n\n🧠 Why It Works:\nOpponent's power and escape options decrease the higher you go.\n\nYour ability to apply force, create torque, and finish increases.\n\nIt avoids stalling at low control points, where defense is strongest.\n\n🦴 Biomechanical Chain:\nStep\tExample\nAnkle\tGrab → lift → disrupt base\nKnee\tShelf it on thigh or shoulder\nHip\tBring hips in → elevate\nTorso\tWrap waist → initiate lift or trip\nHead/Shoulders\tCrunch down → pin or transition\n\n🔁 Cross-Disciplinary Use (BJJ, Judo):\nSingle-leg to body lock to trip = ladder.\n\nGuard pass: control ankles → knees → hips → underhook → crossface.\n\nBack take: trap leg → seatbelt → chin/jaw.\n\n🧠 Training Principle:\nDon’t settle at the bottom. Climb.\n\nEvery pause at a lower rung gives the opponent time to post, sprawl, or scramble. Momentum and pressure must be chained upward with intent.",
    "short_description": "",
    "category": "Tactic",
    "color": "#8A2BE2",
